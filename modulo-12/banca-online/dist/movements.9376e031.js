...
var getMovements = function getMovements(id) {
  return _axios.default.get("".concat(url, "?accountId=").concat(id)).then(function (response) {
...
var url = "".concat("http://localhost:3000/api", "/account"); // export const insertAccount = (account) =>
...
exports.mapMovementsListFromApiToViewModel = exports.mapAccountFromApiToViewModel = void 0;

var mapMovementsListFromApiToViewModel = function mapMovementsListFromApiToViewModel(movementsList) {
  return movementsList.map(function (movement) {
    return mapMovementFromApiToViewModel(movement);
  });
};

exports.mapMovementsListFromApiToViewModel = mapMovementsListFromApiToViewModel;
...
(0, _movements.getMovements)(params.id).then(function (data) {
  (0, _movements2.addMovementRows)((0, _movements3.mapMovementsListFromApiToViewModel)(data));
});
(0, _account.getAccount)(params.id).then(function (account) {
  (0, _element.onSetValues)((0, _movements3.mapAccountFromApiToViewModel)(account));
});
},{"../../core/router":"core/router/index.js","./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","../account/account.api":"pages/account/account.api.js","./movements.mappers":"pages/movements/movements.mappers.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
