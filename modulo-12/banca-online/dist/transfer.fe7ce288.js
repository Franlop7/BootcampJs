...
var set_1 = set; // TODO: Better naming for this?
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"../node_modules/@lemoncode/fonk-range-number-validator/dist/@lemoncode/fonk-range-number-validator.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rangeNumber = void 0;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js":[function(require,module,exports) {
"use strict";
...
var _fonkRangeNumberValidator = require("@lemoncode/fonk-range-number-validator");
...
var validationSchema = {
  field: {
    ...
    day: [{
      validator: _fonkRangeNumberValidator.rangeNumber.validator,
      customArgs: {
        strictTypes: true,
        min: {
          value: 0,
    ...
    year: [{
      ...
      customArgs: {
        ...
        max: {
          ...
          //Permito que el año de la transacción sea el actual o el siguiente
          inclusive: true
        }
      },
      message: 'Fecha no válida'
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-min-number-validator":"../node_modules/@lemoncode/fonk-min-number-validator/dist/@lemoncode/fonk-min-number-validator.esm.js","@lemoncode/fonk-range-number-validator":"../node_modules/@lemoncode/fonk-range-number-validator/dist/@lemoncode/fonk-range-number-validator.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js"}],"pages/transfer/transfer.mappers.js":[function(require,module,exports) {
"use strict";
...
},{}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";
...
var url = "".concat("http://localhost:3000/api", "/transfers");

var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post("".concat(url), transfer).then(function (response) {
    return response.data;
  });
};
...
var _transfer3 = require("./transfer.mappers");

var _transfer4 = require("./transfer.api");
...
(0, _accountList.getAccountList)(params.id).then(function (data) {
  (0, _transfer.setAccountOptions)(data, params.id);
});
var transfer = {
  accountId: params.id,
  iban: '',
...
(0, _element.onUpdateField)('select-account', function (event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    accountId: value
  });
});
(0, _element.onUpdateField)('iban', function (event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    iban: value
  });

  _transfer2.formValidation.validateField('iban', value).then(function (result) {
    (0, _element.onSetError)('iban', result);
  });
});
(0, _element.onUpdateField)('name', function (event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    name: value
  });

  _transfer2.formValidation.validateField('name', value).then(function (result) {
    (0, _element.onSetError)('name', result);
  });
});
(0, _element.onUpdateField)('amount', function (event) {
  var value = Number(event.target.value);
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    amount: value
  });

  _transfer2.formValidation.validateField('amount', value).then(function (result) {
    (0, _element.onSetError)('amount', result);
  });
});
(0, _element.onUpdateField)('concept', function (event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    concept: value
  });

  _transfer2.formValidation.validateField('concept', value).then(function (result) {
    (0, _element.onSetError)('concept', result);
  });
});
...
(0, _element.onUpdateField)('day', function (event) {
  var value = Number(event.target.value);
  transfer.day = value;
  transfer.date = "".concat(transfer.year, "-").concat(transfer.month, "-").concat(transfer.day);

  _transfer2.formValidation.validateField('day', value).then(function (result) {
    (0, _element.onSetError)('date', result);
  });
});
(0, _element.onUpdateField)('month', function (event) {
  var value = Number(event.target.value);
  transfer.month = value;
  transfer.date = "".concat(transfer.year, "-").concat(transfer.month, "-").concat(transfer.day);

  _transfer2.formValidation.validateField('month', value).then(function (result) {
    (0, _element.onSetError)('date', result);
  });
});
(0, _element.onUpdateField)('year', function (event) {
  var value = Number(event.target.value);
  transfer.year = value;
  transfer.date = "".concat(transfer.year, "-").concat(transfer.month, "-").concat(transfer.day);

  _transfer2.formValidation.validateField('year', value).then(function (result) {
    (0, _element.onSetError)('date', result);
  });
});
(0, _element.onUpdateField)('email', function (event) {
  ...
  _transfer2.formValidation.validateField('email', value).then(function (result) {
    (0, _element.onSetError)('email', result);
  });
});
(0, _element.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(transfer).then(function (result) {
    (0, _element.onSetFormErrors)(result);

    if (result.succeeded) {
      (0, _transfer4.insertTransfer)((0, _transfer3.mapTransferFromViewModelToApi)(transfer));

      _router.history.back();
    }
  });
});
},{"../../core/router":"core/router/index.js","../account-list/account-list.api":"pages/account-list/account-list.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "57901" + '/');
