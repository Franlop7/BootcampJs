...
exports.mapAccountListFromApiViewMoel = void 0;

var mapAccountListFromApiViewMoel = function mapAccountListFromApiViewMoel(accountlist) {
  return accountlist.map(function (account) {
    return mapAccountFromApiToViewModel(account);
  });
};

exports.mapAccountListFromApiViewMoel = mapAccountListFromApiViewMoel;
...
(0, _accountList.getAccountList)().then(function (accountList) {
  var viewModelAccountList = (0, _accountList3.mapAccountListFromApiViewMoel)(accountList);
